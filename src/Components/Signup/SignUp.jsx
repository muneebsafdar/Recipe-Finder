...
function SignUp() {
    ...
    const submit=async ({fullName,email,password})=>{
      ...
      try {
         const UserData=appwriteAuthService.CreateUser(email.trim(),password.trim(),fullName.trim())
        if (UserData) {
        ...
        <div className='w-[40%] bg-white mx-auto mt-5 p-5  shadow-gray-800 shadow-2xl rounded-lg flex flex-col mb-10'>
            <div className='flex flex-col items-center mb-6'>
               <div className='size-20 rounded-full shadow-lg mb-2 bg-gray-800 p-4'>
                ...
                <Heading children={"Sign Up To Create Account"} className='text-3xl text-center' />
